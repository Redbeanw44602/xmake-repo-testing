package("mdns_cpp")
    ...
    on_install("!wasm", function (package)
        ...
        io.replace("CMakeLists.txt", "target_link_libraries(${PROJECT_NAME} INTERFACE iphlpapi ws2_32)", "target_link_libraries(${PROJECT_NAME} PRIVATE iphlpapi ws2_32)", {plain = true})
